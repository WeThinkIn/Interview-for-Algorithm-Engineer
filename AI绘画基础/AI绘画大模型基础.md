...
- [31.长宽比分桶训练策略（Aspect Ratio Bucketing）有什么作用?](#31.长宽比分桶训练策略（Aspect Ratio Bucketing）有什么作用?)
...
<h2 id="31.长宽比分桶训练策略（Aspect Ratio Bucketing）有什么作用?">31.长宽比分桶训练策略（Aspect Ratio Bucketing）有什么作用?</h2>
